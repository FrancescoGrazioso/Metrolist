...
// TODO: Re-enable once protobuf generation is configured
...
class MessageCodec(
    ...
    fun encode(msgType: String, payload: Any?): ByteArray {
        // TODO: Re-enable protobuf encoding once proto generation is configured
    ...
    fun decode(data: ByteArray): Pair<String, ByteArray> {
        ...
        // TODO: Re-enable protobuf decoding once proto generation is configured
        // return if (detectedFormat == MessageFormat.PROTOBUF) {
        //     decodeProtobuf(data)
        // } else {
        //     decodeJson(data)
        // }
        if (detectedFormat == MessageFormat.PROTOBUF) {
            Timber.tag(TAG).w("Protobuf decoding is not yet available, attempting JSON fallback")
        }
